...
/*
 ...
 Пример:
   ...
   добавит такой обработчик кликов для body, который будет вызывать указанную функцию
   только если кликнули на кнопку (элемент с тегом button)
 */
...
function once(target, fn) {
    var i = 0,
        fnOne= function() {
            ...
            ++i;
            if (i === 1) {
                target.removeEventListener('click', fnOne);
            }
        };

    target.addEventListener('click', fnOne);
